...
void StepperMotor_construct(StepperMotor_t *stepper){
	...
	stepper->stepMultiple = &(USER_PARAMS_[2]);			//assign the user params from the gui to step size
	stepper->direction = DIRECTION_ANTICLOCKWISE_;		//defult anticlockwise to follow gui
